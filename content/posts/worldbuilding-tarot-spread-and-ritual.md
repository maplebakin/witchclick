...
Card 1 — Tone & Genre Thread 
What mood or genre spine runs through the world? (Horror, hopepunk, mythic slice-of-life?)

Card 2 — Map & Borders 
What landscape shapes travel and trade? Borders, rivers, sky-rails, portals.

Card 3 — Power & Law 
Who makes rules? Crowns, councils, guilds, gods, code.

Card 4 — Magic/Tech Cost 
What is the price of wonder? Fuel, favor, memory, time.

Card 5 — Everyday Texture 
What do people eat, wear, celebrate, and complain about? Markets, weather, crafts.

Card 6 — Conflict Engine 
What keeps stories moving? Scarcity, ideology, monsters, failing infrastructure.

Card 7 — Hook & Session Zero 
What first quest or chapter naturally begins here? A delivery, a festival, a blackout.
...
Ritual 
1. Clear the space. Wipe the surface, light the candle, place your token. Say: I’m weaving a world that plays well. 
2. Shuffle with a prompt. Whisper: Tone, map, law, cost, texture, conflict, hook. 
3. Lay the World Loom. Place cards 1–6 left to right, top then middle rows, then crown with card 7. 
4. Read aloud and write. For each card, write one sentence and one concrete example. In your journal, bold the sentence that players/readers will actually feel. 
5. Name three test scenes. After card 7, list three micro-scenes the world invites right now. 
6. Close. Pinch the candle out. Touch your token. Say: The loom holds; I’ll return.
...
Session rhythm 
Work in two or three focused blocks. Between blocks, take a 3–5 minute reset: stretch, drink water, or play a single round of cozy games. Return with one clear next step.
